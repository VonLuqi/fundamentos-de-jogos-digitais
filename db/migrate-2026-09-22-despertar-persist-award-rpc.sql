-- Migração 2026-09-22
-- Objetivo: RPC híbrida de persistência + award (Fase B / Task B3)
-- docs/otimizacoes/contratos-fase-b.md §2 · 02-tasks-fase-b-rtt-batching.md
--
-- Validação de economia permanece em Node (validateSync).
-- Esta função só persiste o patch já autenticado e aplica conquistas filtradas.
...
COMMENT ON FUNCTION public.despertar_persist_and_award(integer, jsonb, text[], integer) IS
  'Fase B / B3: persiste patch de despertar_states + append de conquistas/xp. Sem validação de economia.';
