...
assert(AUTH_RATE_LIMITS.legacy_bind_ip.max === Infinity, 'recuperação Caronte sem teto');
assert(AUTH_RATE_LIMITS.soul_recovery_consume_ip.max === Infinity, 'recuperação de almas sem teto');
assert(AUTH_RATE_LIMITS.register_ip.max === Infinity, 'registro sem teto');
